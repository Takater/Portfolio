...
function Contact () {
    ...
    return (
        <div id="contact">
            ...
            >
                <a className="contactLink" href="tel:5569948282019"><button className="btn btn-outline-primary">Phone</button></a>
                <a className="contactLink" href="https://web.whatsapp.com/send?phone=5569984282019&text=Hello%2C%20Guilherme%21%20I%20came%20from%20your%20Portfolio.%20Nice%20to%20meet%20you%21"><button className="btn btn-outline-primary"> WhatsApp</button></a>
